...
// checks if the UpdateInsightDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateInsightDto{}

// UpdateInsightDto struct for UpdateInsightDto
type UpdateInsightDto struct {
	// Insight Page Name
...
func (o UpdateInsightDto) MarshalJSON() ([]byte, error) {
...
func (o UpdateInsightDto) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateInsightDto struct {
	value *UpdateInsightDto
	isSet bool
}

func (v NullableUpdateInsightDto) Get() *UpdateInsightDto {
	return v.value
}

func (v *NullableUpdateInsightDto) Set(val *UpdateInsightDto) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateInsightDto) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateInsightDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateInsightDto(val *UpdateInsightDto) *NullableUpdateInsightDto {
	return &NullableUpdateInsightDto{value: val, isSet: true}
}

func (v NullableUpdateInsightDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateInsightDto) UnmarshalJSON(src []byte) error {
	v.isSet = true

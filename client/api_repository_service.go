...
func (a *RepositoryServiceAPIService) FindAllExecute(r ApiFindAllRequest) (*FindAllTopReposByUsername200Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/repos/list"
...
type ApiFindAllContributorsByRepoIdRequest struct {
	ctx               context.Context
	ApiService        *RepositoryServiceAPIService
	owner             string
	repo              string
...
// Previous number of days to go back to start date range
func (r ApiFindAllContributorsByRepoIdRequest) PrevDaysStartDate(prevDaysStartDate int32) ApiFindAllContributorsByRepoIdRequest {
	r.prevDaysStartDate = &prevDaysStartDate
	return r
}

// Range in days
func (r ApiFindAllContributorsByRepoIdRequest) Range_(range_ int32) ApiFindAllContributorsByRepoIdRequest {
	r.range_ = &range_
	return r
}
...
/*
FindAllContributorsByRepoId Finds a repo by :owner and :repo listing all contributions by their user login

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param owner
	@param repo
	@return ApiFindAllContributorsByRepoIdRequest
*/
func (a *RepositoryServiceAPIService) FindAllContributorsByRepoId(ctx context.Context, owner string, repo string) ApiFindAllContributorsByRepoIdRequest {
	return ApiFindAllContributorsByRepoIdRequest{
		ApiService: a,
		ctx:        ctx,
		owner:      owner,
...
func (a *RepositoryServiceAPIService) FindAllContributorsByRepoIdExecute(r ApiFindAllContributorsByRepoIdRequest) ([]DbRepoLoginContributions, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/repos/{owner}/{repo}/contributions/contributors"
	localVarPath = strings.Replace(localVarPath, "{"+"owner"+"}", url.PathEscape(parameterValueToString(r.owner, "owner")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"repo"+"}", url.PathEscape(parameterValueToString(r.repo, "repo")), -1)
...
func (a *RepositoryServiceAPIService) FindAllReposWithFiltersExecute(r ApiFindAllReposWithFiltersRequest) (*FindAllTopReposByUsername200Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/repos/search"
...
func (a *RepositoryServiceAPIService) FindOneByIdExecute(r ApiFindOneByIdRequest) (*DbRepo, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/repos/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (a *RepositoryServiceAPIService) FindOneByOwnerAndRepoExecute(r ApiFindOneByOwnerAndRepoRequest) (*DbRepo, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/repos/{owner}/{repo}"
	localVarPath = strings.Replace(localVarPath, "{"+"owner"+"}", url.PathEscape(parameterValueToString(r.owner, "owner")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"repo"+"}", url.PathEscape(parameterValueToString(r.repo, "repo")), -1)

...
// checks if the DbWorkspaceContributor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DbWorkspaceContributor{}

// DbWorkspaceContributor struct for DbWorkspaceContributor
type DbWorkspaceContributor struct {
	// Workspace contributor identifier
	Id string `json:"id"`
	// Contributor identifier
	ContributorId int32 `json:"contributor_id"`
...
func (o DbWorkspaceContributor) MarshalJSON() ([]byte, error) {
...
func (o DbWorkspaceContributor) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	toSerialize["contributor_id"] = o.ContributorId
...
type NullableDbWorkspaceContributor struct {
	value *DbWorkspaceContributor
	isSet bool
}

func (v NullableDbWorkspaceContributor) Get() *DbWorkspaceContributor {
	return v.value
}

func (v *NullableDbWorkspaceContributor) Set(val *DbWorkspaceContributor) {
	v.value = val
	v.isSet = true
}

func (v NullableDbWorkspaceContributor) IsSet() bool {
	return v.isSet
}

func (v *NullableDbWorkspaceContributor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDbWorkspaceContributor(val *DbWorkspaceContributor) *NullableDbWorkspaceContributor {
	return &NullableDbWorkspaceContributor{value: val, isSet: true}
}

func (v NullableDbWorkspaceContributor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDbWorkspaceContributor) UnmarshalJSON(src []byte) error {
	v.isSet = true

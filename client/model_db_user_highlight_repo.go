...
// checks if the DbUserHighlightRepo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DbUserHighlightRepo{}
...
type NullableDbUserHighlightRepo struct {
	value *DbUserHighlightRepo
	isSet bool
}

func (v NullableDbUserHighlightRepo) Get() *DbUserHighlightRepo {
	return v.value
}

func (v *NullableDbUserHighlightRepo) Set(val *DbUserHighlightRepo) {
	v.value = val
	v.isSet = true
}

func (v NullableDbUserHighlightRepo) IsSet() bool {
	return v.isSet
}

func (v *NullableDbUserHighlightRepo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDbUserHighlightRepo(val *DbUserHighlightRepo) *NullableDbUserHighlightRepo {
	return &NullableDbUserHighlightRepo{value: val, isSet: true}
}

func (v NullableDbUserHighlightRepo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDbUserHighlightRepo) UnmarshalJSON(src []byte) error {
	v.isSet = true

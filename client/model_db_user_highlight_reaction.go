...
type DbUserHighlightReaction struct {
	...
	HighlightId float32 `json:"highlight_id"`
	// User identifier
	...
	ReactionCount *float32 `json:"reaction_count,omitempty"`
}
...
// SetReactionCount gets a reference to the given float32 and assigns it to the ReactionCount field.

...
// checks if the DbBakedRepo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DbBakedRepo{}

// DbBakedRepo struct for DbBakedRepo
type DbBakedRepo struct {
	// Baked repository identifier
	Id int32 `json:"id"`
...
func (o DbBakedRepo) MarshalJSON() ([]byte, error) {
...
func (o DbBakedRepo) ToMap() (map[string]interface{}, error) {
...
type NullableDbBakedRepo struct {
	value *DbBakedRepo
	isSet bool
}

func (v NullableDbBakedRepo) Get() *DbBakedRepo {
	return v.value
}

func (v *NullableDbBakedRepo) Set(val *DbBakedRepo) {
	v.value = val
	v.isSet = true
}

func (v NullableDbBakedRepo) IsSet() bool {
	return v.isSet
}

func (v *NullableDbBakedRepo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDbBakedRepo(val *DbBakedRepo) *NullableDbBakedRepo {
	return &NullableDbBakedRepo{value: val, isSet: true}
}

func (v NullableDbBakedRepo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDbBakedRepo) UnmarshalJSON(src []byte) error {
	v.isSet = true

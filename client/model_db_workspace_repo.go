...
// checks if the DbWorkspaceRepo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DbWorkspaceRepo{}

// DbWorkspaceRepo struct for DbWorkspaceRepo
type DbWorkspaceRepo struct {
...
func (o DbWorkspaceRepo) MarshalJSON() ([]byte, error) {
...
func (o DbWorkspaceRepo) ToMap() (map[string]interface{}, error) {
...
type NullableDbWorkspaceRepo struct {
	value *DbWorkspaceRepo
	isSet bool
}

func (v NullableDbWorkspaceRepo) Get() *DbWorkspaceRepo {
	return v.value
}

func (v *NullableDbWorkspaceRepo) Set(val *DbWorkspaceRepo) {
	v.value = val
	v.isSet = true
}

func (v NullableDbWorkspaceRepo) IsSet() bool {
	return v.isSet
}

func (v *NullableDbWorkspaceRepo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDbWorkspaceRepo(val *DbWorkspaceRepo) *NullableDbWorkspaceRepo {
	return &NullableDbWorkspaceRepo{value: val, isSet: true}
}

func (v NullableDbWorkspaceRepo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDbWorkspaceRepo) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the DbRepoToUserStargazers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DbRepoToUserStargazers{}

// DbRepoToUserStargazers struct for DbRepoToUserStargazers
type DbRepoToUserStargazers struct {
	// Stargaze identifier
	Id int32 `json:"id"`
	// User identifier
	...
	// Timestamp representing stargaze creation
	CreatedAt *time.Time `json:"created_at,omitempty"`
	// Timestamp representing stargaze last update
...
func (o DbRepoToUserStargazers) MarshalJSON() ([]byte, error) {
...
func (o DbRepoToUserStargazers) ToMap() (map[string]interface{}, error) {
...
type NullableDbRepoToUserStargazers struct {
	value *DbRepoToUserStargazers
	isSet bool
}

func (v NullableDbRepoToUserStargazers) Get() *DbRepoToUserStargazers {
	return v.value
}

func (v *NullableDbRepoToUserStargazers) Set(val *DbRepoToUserStargazers) {
	v.value = val
	v.isSet = true
}

func (v NullableDbRepoToUserStargazers) IsSet() bool {
	return v.isSet
}

func (v *NullableDbRepoToUserStargazers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDbRepoToUserStargazers(val *DbRepoToUserStargazers) *NullableDbRepoToUserStargazers {
	return &NullableDbRepoToUserStargazers{value: val, isSet: true}
}

func (v NullableDbRepoToUserStargazers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDbRepoToUserStargazers) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
type DbEndorsement struct {
	...
	CreatorUserId *float32 `json:"creator_user_id,omitempty"`
	// Endorsement Recipient User ID
	RecipientUserId *float32 `json:"recipient_user_id,omitempty"`
	// Repository ID
...
// SetCreatorUserId gets a reference to the given float32 and assigns it to the CreatorUserId field.
...
// SetRecipientUserId gets a reference to the given float32 and assigns it to the RecipientUserId field.

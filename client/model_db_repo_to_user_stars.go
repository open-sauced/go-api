...
// checks if the DbRepoToUserStars type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DbRepoToUserStars{}

// DbRepoToUserStars struct for DbRepoToUserStars
type DbRepoToUserStars struct {
	// Star identifier
	Id int32 `json:"id"`
	// User identifier
	...
	// Timestamp representing star creation
	CreatedAt *time.Time `json:"created_at,omitempty"`
	// Timestamp representing star last update
...
func (o DbRepoToUserStars) MarshalJSON() ([]byte, error) {
...
func (o DbRepoToUserStars) ToMap() (map[string]interface{}, error) {
...
type NullableDbRepoToUserStars struct {
	value *DbRepoToUserStars
	isSet bool
}

func (v NullableDbRepoToUserStars) Get() *DbRepoToUserStars {
	return v.value
}

func (v *NullableDbRepoToUserStars) Set(val *DbRepoToUserStars) {
	v.value = val
	v.isSet = true
}

func (v NullableDbRepoToUserStars) IsSet() bool {
	return v.isSet
}

func (v *NullableDbRepoToUserStars) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDbRepoToUserStars(val *DbRepoToUserStars) *NullableDbRepoToUserStars {
	return &NullableDbRepoToUserStars{value: val, isSet: true}
}

func (v NullableDbRepoToUserStars) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDbRepoToUserStars) UnmarshalJSON(src []byte) error {
	v.isSet = true

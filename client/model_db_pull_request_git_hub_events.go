...
// checks if the DbPullRequestGitHubEvents type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DbPullRequestGitHubEvents{}

// DbPullRequestGitHubEvents struct for DbPullRequestGitHubEvents
type DbPullRequestGitHubEvents struct {
...
func NewDbPullRequestGitHubEvents(eventId int32, prNumber int32, prState string, prIsDraft bool, prIsMerged bool, prMergeableState string, prIsRebaseable bool, prTitle string, prHeadLabel string, prBaseLabel string, prHeadRef string, prBaseRef string, prAuthorLogin string, prClosedAt time.Time, prMergedAt time.Time, prUpdatedAt time.Time, prComments int32, prAdditions int32, prDeletions int32, prChangedFiles int32, repoName string, prCommits int32) *DbPullRequestGitHubEvents {
	this := DbPullRequestGitHubEvents{}
...
func (o DbPullRequestGitHubEvents) MarshalJSON() ([]byte, error) {
...
func (o DbPullRequestGitHubEvents) ToMap() (map[string]interface{}, error) {
...
type NullableDbPullRequestGitHubEvents struct {
	value *DbPullRequestGitHubEvents
	isSet bool
}

func (v NullableDbPullRequestGitHubEvents) Get() *DbPullRequestGitHubEvents {
	return v.value
}

func (v *NullableDbPullRequestGitHubEvents) Set(val *DbPullRequestGitHubEvents) {
	v.value = val
	v.isSet = true
}

func (v NullableDbPullRequestGitHubEvents) IsSet() bool {
	return v.isSet
}

func (v *NullableDbPullRequestGitHubEvents) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDbPullRequestGitHubEvents(val *DbPullRequestGitHubEvents) *NullableDbPullRequestGitHubEvents {
	return &NullableDbPullRequestGitHubEvents{value: val, isSet: true}
}

func (v NullableDbPullRequestGitHubEvents) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDbPullRequestGitHubEvents) UnmarshalJSON(src []byte) error {
	v.isSet = true
